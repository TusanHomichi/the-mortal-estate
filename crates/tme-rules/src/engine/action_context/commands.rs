...
impl Engine {
    ...
    pub fn validate_actor_command(
        ...
        let requesting_return =
            matches!(command.intent, PlayerIntentPayloadV1::RequestResurrection);
        if !player.is_alive() && !requesting_return {
        ...
        match &command.intent {
            PlayerIntentPayloadV1::RequestResurrection => {
                match self.requested_resurrection_plan(player_index) {
    ...
    pub fn command_to_actor_intent(
        ...
        match &command.intent {
            ...
            PlayerIntentPayloadV1::RequestResurrection => Ok(PlayerIntent::RequestResurrection),
