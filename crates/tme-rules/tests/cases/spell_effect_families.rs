...
#[path = "spell_effect_families/typed_capabilities_apply_without_stub_or_invented_consumers.rs"]
mod typed_capabilities_apply_without_stub_or_invented_consumers;
