...
**Delivered baseline:** [PR #53](https://github.com/TusanHomichi/the-mortal-estate/pull/53)
merged as `0ca9156`. The [live-dungeon execution record](2026-09-10-live-dungeons.md)
...
**Gameplay and content:** the [gameplay baseline](../gameplay-baseline.md),
[class contract](../class-training-contract.md), and
[four-floor plan](2026-09-09-dungeon-one.md) own fidelity, class work and authored
traversal. [Issue #54](https://github.com/TusanHomichi/the-mortal-estate/issues/54)
...
are also dated history; open either only when the task needs that evidence.
