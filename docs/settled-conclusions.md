...
revision: 17
status: Authored at genesis plan Phase 7; a live index that grows as slices close. Revision 17 records structural geometry and the character card-production ruling.
public_safe: true
