...
revision: 14
status: Authored at genesis plan Phase 7; a live index that grows as slices close. Revision 14 records the owner-ruled cursor readiness and absence of a visible pulse outside combat.
public_safe: true
