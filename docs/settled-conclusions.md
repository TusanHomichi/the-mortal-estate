...
revision: 16
status: Authored at genesis plan Phase 7; a live index that grows as slices close. Revision 16 records dedicated interior spaces, door portals, and always-on exterior roofs.
public_safe: true
...
| Spaces and portals | The world is a set of spaces joined by portals; a portal is a door tile, and landing on it puts the player on the target tile in the target space at the strike. Interiors carry no weather. | [client notes](client-notes.md#the-web-feel-scenes-walk-experiment) — owner ruling 2026-09-02 |
