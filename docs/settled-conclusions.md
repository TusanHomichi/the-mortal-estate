...
| --- | --- | --- |
| Implementation stack | A Rust workspace for rules, wire DTOs, simulation, authoring, and one authoritative server; a thin Godot client; Python for repository checks, tools, and proof harnesses. Widening the stack is a decision, not a convenience. | [AGENTS.md](../AGENTS.md) |
