...
revision: 22
status: Authored at genesis plan Phase 7; a live index that grows as slices close. Revision 18 records the viewport frame and prop scale rulings; revision 19 the interior camera; revision 20 the chrome; revision 21 the actions; revision 22 the accepted chrome layout.
public_safe: true
